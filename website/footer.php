<!-- FOOTER SECTION -->
    <div class="row footer text-center">
        <div class="col-md-4">
            <a class="btn-std" href="http://maps.google.com/?q=-25.449753,-49.232942" target="_blank">
                <img src="images/pin.png" class="img-responsive center-block margin-20" alt="Pino no mapa">
                <address>
