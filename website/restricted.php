        ...
        <div class="barcode-reader text-center">
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="input-group has-feedback">
                    ...
                    <input type="text" name="cod" class="form-control" id="codInput" placeholder="Número da carteirinha" min="100000000000" max="999999999999" maxlength="12" oninput="maxLengthCheck(this)" data-error="Número de carteirinha inválido" value="<?= $_GET['codigo_deb'] ?>" />
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <div class="help-block with-errors"></div>
                </div>
